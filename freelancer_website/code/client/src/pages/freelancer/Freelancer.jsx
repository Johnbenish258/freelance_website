...
const Freelancer = () => {
  ...
  const fetchUserData = async(id) =>{
      axios.get(`/fetch-freelancer/${id}`).then(
        (response)=>{
  ...
  const updateUserData = async() =>{
    axios.post(`/update-freelancer`, {freelancerId, updateSkills: updateSkills, description: updateDescription}).then(
        (response)=>{
          fetchUserData();
  ...
  const fetchApplications = async() =>{
    await axios.get("/fetch-applications").then(
      (response)=>{
